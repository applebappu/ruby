...
class AboutSymbols < Neo::Koan
  ...
  # My Answer: because if they remained symbols, they're less distinct 
  # (see idential_symbols_are_a_single_internal_object)

  in_ruby_version("mri") do # i wonder what "mri" is in this context
